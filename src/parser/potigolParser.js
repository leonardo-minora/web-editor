...
var literalNames = [ null, "'escreva'", "'imprima'", "':='", "'['", "']'", 
                     "':'", "'='", "'var'", "'('", "')'", "'fim'", "'tipo'", 
                     "'abstrato'", "'use'", "'retorne'", "','", "'=>'", 
                     "'.'", "'^'", "'::'", "'+'", "'-'", "'*'", "'/'", "'div'", 
                     "'mod'", "'formato'", "'>'", "'>='", "'<'", "'<='", 
                     "'=='", "'<>'", "'nao'", "'n\\u00e3o'", "'e'", "'ou'", 
                     "'isto'", "'_'", "'se'", "'entao'", "'ent\\u00e3o'", 
                     "'senaose'", "'sen\\u00e3ose'", "'senao'", "'sen\\u00e3o'", 
                     "'escolha'", "'caso'", "'|'", "'para'", "'gere'", "'enquanto'", 
...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, null, null, "ID", "INT", "FLOAT", 
                      "STRING", "BS", "MS", "ES", "CHAR", "BOOLEANO", "WS", 
                      "COMMENT", "NL" ];

var ruleNames =  [ "prog", "inst", "cmd", "decl", "decl_valor", "decl_funcao", 
                   "decl_tipo", "membros", "decl_uso", "retorne", "dcl", 
                   "dcl_var", "dcl_fun", "dcls", "dcl1", "tipo", "expr", 
                   "literal", "decisao", "se", "entao", "senaose", "senao", 
                   "escolha", "caso", "padrao", "repeticao", "para_faca", 
                   "para_gere", "enquanto", "faixa", "faixas", "bloco", 
                   "expr1", "expr2", "id1", "id2", "qualid", "qualid1", 
...
potigolParser.T__58 = 59;
potigolParser.ID = 60;
potigolParser.INT = 61;
potigolParser.FLOAT = 62;
potigolParser.STRING = 63;
potigolParser.BS = 64;
potigolParser.MS = 65;
potigolParser.ES = 66;
potigolParser.CHAR = 67;
potigolParser.BOOLEANO = 68;
potigolParser.WS = 69;
potigolParser.COMMENT = 70;
potigolParser.NL = 71;
...
potigolParser.RULE_membros = 7;
potigolParser.RULE_decl_uso = 8;
potigolParser.RULE_retorne = 9;
potigolParser.RULE_dcl = 10;
potigolParser.RULE_dcl_var = 11;
potigolParser.RULE_dcl_fun = 12;
potigolParser.RULE_dcls = 13;
potigolParser.RULE_dcl1 = 14;
potigolParser.RULE_tipo = 15;
potigolParser.RULE_expr = 16;
potigolParser.RULE_literal = 17;
potigolParser.RULE_decisao = 18;
potigolParser.RULE_se = 19;
potigolParser.RULE_entao = 20;
potigolParser.RULE_senaose = 21;
potigolParser.RULE_senao = 22;
potigolParser.RULE_escolha = 23;
potigolParser.RULE_caso = 24;
potigolParser.RULE_padrao = 25;
potigolParser.RULE_repeticao = 26;
potigolParser.RULE_para_faca = 27;
potigolParser.RULE_para_gere = 28;
potigolParser.RULE_enquanto = 29;
potigolParser.RULE_faixa = 30;
potigolParser.RULE_faixas = 31;
potigolParser.RULE_bloco = 32;
potigolParser.RULE_expr1 = 33;
potigolParser.RULE_expr2 = 34;
potigolParser.RULE_id1 = 35;
potigolParser.RULE_id2 = 36;
potigolParser.RULE_qualid = 37;
potigolParser.RULE_qualid1 = 38;
potigolParser.RULE_qualid2 = 39;
potigolParser.RULE_tipo2 = 40;
potigolParser.RULE_exprlist = 41;
...
potigolParser.prototype.prog = function() {
    ...
    try {
        ...
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << potigolParser.T__0) | (1 << potigolParser.T__1) | (1 << potigolParser.T__3) | (1 << potigolParser.T__7) | (1 << potigolParser.T__8) | (1 << potigolParser.T__11) | (1 << potigolParser.T__13) | (1 << potigolParser.T__20) | (1 << potigolParser.T__21))) !== 0) || ((((_la - 34)) & ~0x1f) == 0 && ((1 << (_la - 34)) & ((1 << (potigolParser.T__33 - 34)) | (1 << (potigolParser.T__34 - 34)) | (1 << (potigolParser.T__37 - 34)) | (1 << (potigolParser.T__38 - 34)) | (1 << (potigolParser.T__39 - 34)) | (1 << (potigolParser.T__46 - 34)) | (1 << (potigolParser.T__49 - 34)) | (1 << (potigolParser.T__51 - 34)) | (1 << (potigolParser.T__57 - 34)) | (1 << (potigolParser.T__58 - 34)) | (1 << (potigolParser.ID - 34)) | (1 << (potigolParser.INT - 34)) | (1 << (potigolParser.FLOAT - 34)) | (1 << (potigolParser.STRING - 34)) | (1 << (potigolParser.BS - 34)))) !== 0) || _la===potigolParser.CHAR || _la===potigolParser.BOOLEANO) {
            this.state = 84;
            this.inst();
            this.state = 89;
            this._errHandler.sync(this);
...
Decl_var_multiplaContext.prototype.tipo = function() {
...
Valor_multiploContext.prototype.tipo = function() {
    return this.getTypedRuleContext(TipoContext,0);
};
...
Valor_simplesContext.prototype.tipo = function() {
    return this.getTypedRuleContext(TipoContext,0);
};
...
Decl_var_simplesContext.prototype.tipo = function() {
    return this.getTypedRuleContext(TipoContext,0);
};
...
potigolParser.prototype.decl_valor = function() {
    ...
    try {
        ...
        case 3:
            ...
            this.state = 150;
            _la = this._input.LA(1);
            if(!(_la===potigolParser.T__2 || _la===potigolParser.T__6)) {
...
ClasseContext.prototype.membros = function() {
    return this.getTypedRuleContext(MembrosContext,0);
};

ClasseContext.prototype.id1 = function() {
    return this.getTypedRuleContext(Id1Context,0);
};
...
function InterfaceContext(parser, ctx) {
	Decl_tipoContext.call(this, parser);
    Decl_tipoContext.prototype.copyFrom.call(this, ctx);
    return this;
}

InterfaceContext.prototype = Object.create(Decl_tipoContext.prototype);
InterfaceContext.prototype.constructor = InterfaceContext;

potigolParser.InterfaceContext = InterfaceContext;

InterfaceContext.prototype.ID = function() {
    return this.getToken(potigolParser.ID, 0);
};

InterfaceContext.prototype.membros = function() {
    return this.getTypedRuleContext(MembrosContext,0);
};

InterfaceContext.prototype.id1 = function() {
    return this.getTypedRuleContext(Id1Context,0);
};
InterfaceContext.prototype.enterRule = function(listener) {
    if(listener instanceof potigolListener ) {
        listener.enterInterface(this);
	}
};

InterfaceContext.prototype.exitRule = function(listener) {
    if(listener instanceof potigolListener ) {
...
potigolParser.prototype.decl_tipo = function() {
    ...
    try {
        ...
        case 3:
            localctx = new InterfaceContext(this, localctx);
            this.enterOuterAlt(localctx, 3);
            this.state = 204;
            this.match(potigolParser.T__11);
            this.state = 205;
...
function MembrosContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = potigolParser.RULE_membros;
    return this;
}

MembrosContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
MembrosContext.prototype.constructor = MembrosContext;

MembrosContext.prototype.dcl = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
MembrosContext.prototype.dcl_var = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
MembrosContext.prototype.dcl_fun = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
        return this.getTypedRuleContexts(Dcl_funContext);
    } else {
        return this.getTypedRuleContext(Dcl_funContext,i);
    }
};

MembrosContext.prototype.decl_funcao = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
MembrosContext.prototype.decl_valor = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
MembrosContext.prototype.enterRule = function(listener) {
    if(listener instanceof potigolListener ) {
        listener.enterMembros(this);
	}
};

MembrosContext.prototype.exitRule = function(listener) {
    if(listener instanceof potigolListener ) {
        listener.exitMembros(this);
	}
};
...
potigolParser.MembrosContext = MembrosContext;

potigolParser.prototype.membros = function() {

    var localctx = new MembrosContext(this, this._ctx, this.state);
    this.enterRule(localctx, 14, potigolParser.RULE_membros);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 223;
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===potigolParser.T__7 || _la===potigolParser.ID) {
            this.state = 221;
            this._errHandler.sync(this);
...
potigolParser.prototype.decl_uso = function() {
    ...
    this.enterRule(localctx, 16, potigolParser.RULE_decl_uso);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 226;
...
potigolParser.prototype.retorne = function() {
    ...
    this.enterRule(localctx, 18, potigolParser.RULE_retorne);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 229;
...
potigolParser.prototype.dcl = function() {
    ...
    this.enterRule(localctx, 20, potigolParser.RULE_dcl);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 232;
        this.id1();
...
potigolParser.prototype.dcl_var = function() {
    ...
    this.enterRule(localctx, 22, potigolParser.RULE_dcl_var);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 236;
        this.match(potigolParser.T__7);
...
function Dcl_funContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = potigolParser.RULE_dcl_fun;
    return this;
}

Dcl_funContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
Dcl_funContext.prototype.constructor = Dcl_funContext;

Dcl_funContext.prototype.ID = function() {
    return this.getToken(potigolParser.ID, 0);
};

Dcl_funContext.prototype.dcls = function() {
    return this.getTypedRuleContext(DclsContext,0);
};

Dcl_funContext.prototype.tipo = function() {
    return this.getTypedRuleContext(TipoContext,0);
};

Dcl_funContext.prototype.enterRule = function(listener) {
    if(listener instanceof potigolListener ) {
        listener.enterDcl_fun(this);
	}
};

Dcl_funContext.prototype.exitRule = function(listener) {
    if(listener instanceof potigolListener ) {
        listener.exitDcl_fun(this);
	}
};
...
potigolParser.Dcl_funContext = Dcl_funContext;

potigolParser.prototype.dcl_fun = function() {

    var localctx = new Dcl_funContext(this, this._ctx, this.state);
    this.enterRule(localctx, 24, potigolParser.RULE_dcl_fun);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 241;
        this.match(potigolParser.ID);
...
potigolParser.prototype.dcls = function() {
    ...
    this.enterRule(localctx, 26, potigolParser.RULE_dcls);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 256;
...
potigolParser.prototype.dcl1 = function() {
    ...
    this.enterRule(localctx, 28, potigolParser.RULE_dcl1);
    try {
        this.state = 267;
        this._errHandler.sync(this);
...
potigolParser.prototype.tipo = function(_p) {
    ...
    var _startState = 30;
    this.enterRecursionRule(localctx, 30, potigolParser.RULE_tipo, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 280;
        this._errHandler.sync(this);
...
potigolParser.prototype.expr = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 32;
    this.enterRecursionRule(localctx, 32, potigolParser.RULE_expr, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 317;
        ...
        case 2:
            ...
            this.state = 292;
            _la = this._input.LA(1);
            if(!(_la===potigolParser.T__20 || _la===potigolParser.T__21)) {
            this._errHandler.recoverInline(this);
            }
            else {
                this.consume();
        ...
        case 3:
            ...
            this.state = 294;
            _la = this._input.LA(1);
            if(!(_la===potigolParser.T__33 || _la===potigolParser.T__34)) {
            this._errHandler.recoverInline(this);
            }
            else {
                this.consume();
        ...
        case 9:
            ...
            this.state = 312;
            _la = this._input.LA(1);
            if(((((_la - 4)) & ~0x1f) == 0 && ((1 << (_la - 4)) & ((1 << (potigolParser.T__3 - 4)) | (1 << (potigolParser.T__8 - 4)) | (1 << (potigolParser.T__20 - 4)) | (1 << (potigolParser.T__21 - 4)) | (1 << (potigolParser.T__33 - 4)) | (1 << (potigolParser.T__34 - 4)))) !== 0) || ((((_la - 38)) & ~0x1f) == 0 && ((1 << (_la - 38)) & ((1 << (potigolParser.T__37 - 38)) | (1 << (potigolParser.T__38 - 38)) | (1 << (potigolParser.T__39 - 38)) | (1 << (potigolParser.T__46 - 38)) | (1 << (potigolParser.T__49 - 38)) | (1 << (potigolParser.T__51 - 38)) | (1 << (potigolParser.ID - 38)) | (1 << (potigolParser.INT - 38)) | (1 << (potigolParser.FLOAT - 38)) | (1 << (potigolParser.STRING - 38)) | (1 << (potigolParser.BS - 38)) | (1 << (potigolParser.CHAR - 38)) | (1 << (potigolParser.BOOLEANO - 38)))) !== 0)) {
                this.state = 311;
                this.expr1();
            }
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 2:
                    ...
                    this.state = 323;
                    this.match(potigolParser.T__19);
                    this.state = 324;
                    this.expr(17);
                    break;
                ...
                case 3:
                    ...
                    this.state = 326;
                    _la = this._input.LA(1);
                    if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << potigolParser.T__22) | (1 << potigolParser.T__23) | (1 << potigolParser.T__24) | (1 << potigolParser.T__25))) !== 0))) {
                    this._errHandler.recoverInline(this);
                    }
                    else {
                        this.consume();
                ...
                case 5:
                    ...
                    this.state = 332;
                    this.match(potigolParser.T__26);
                    this.state = 333;
                    this.expr(14);
                    break;
                ...
                case 6:
                    ...
                    this.state = 335;
                    _la = this._input.LA(1);
                    if(!(((((_la - 28)) & ~0x1f) == 0 && ((1 << (_la - 28)) & ((1 << (potigolParser.T__27 - 28)) | (1 << (potigolParser.T__28 - 28)) | (1 << (potigolParser.T__29 - 28)) | (1 << (potigolParser.T__30 - 28)) | (1 << (potigolParser.T__31 - 28)) | (1 << (potigolParser.T__32 - 28)))) !== 0))) {
                    this._errHandler.recoverInline(this);
                    }
                    else {
                        this.consume();
...
potigolParser.prototype.literal = function() {
    ...
    this.enterRule(localctx, 34, potigolParser.RULE_literal);
    var _la = 0; // Token type
    try {
        this.state = 385;
...
potigolParser.prototype.decisao = function() {
    ...
    this.enterRule(localctx, 36, potigolParser.RULE_decisao);
    try {
        this.state = 389;
        switch(this._input.LA(1)) {
        case potigolParser.T__39:
            this.enterOuterAlt(localctx, 1);
            this.state = 387;
            this.se();
            break;
        case potigolParser.T__46:
            this.enterOuterAlt(localctx, 2);
            this.state = 388;
            this.escolha();
            break;
...
potigolParser.prototype.se = function() {
    ...
    this.enterRule(localctx, 38, potigolParser.RULE_se);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 391;
        this.match(potigolParser.T__39);
        this.state = 392;
        this.expr(0);
        this.state = 393;
        this.entao();
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===potigolParser.T__42 || _la===potigolParser.T__43) {
            this.state = 394;
            this.senaose();
            this.state = 399;
            this._errHandler.sync(this);
        ...
        this.state = 401;
        _la = this._input.LA(1);
        if(_la===potigolParser.T__44 || _la===potigolParser.T__45) {
            this.state = 400;
            this.senao();
        }
...
potigolParser.prototype.entao = function() {
    ...
    this.enterRule(localctx, 40, potigolParser.RULE_entao);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 406;
        _la = this._input.LA(1);
        if(_la===potigolParser.T__40 || _la===potigolParser.T__41) {
            this.state = 405;
            _la = this._input.LA(1);
            if(!(_la===potigolParser.T__40 || _la===potigolParser.T__41)) {
            this._errHandler.recoverInline(this);
...
potigolParser.prototype.senaose = function() {
    ...
    this.enterRule(localctx, 42, potigolParser.RULE_senaose);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 410;
        _la = this._input.LA(1);
        if(!(_la===potigolParser.T__42 || _la===potigolParser.T__43)) {
        this._errHandler.recoverInline(this);
        }
        else {
            this.consume();
...
potigolParser.prototype.senao = function() {
    ...
    this.enterRule(localctx, 44, potigolParser.RULE_senao);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 414;
...
potigolParser.prototype.escolha = function() {
    ...
    this.enterRule(localctx, 46, potigolParser.RULE_escolha);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 417;
...
potigolParser.prototype.caso = function() {
    ...
    this.enterRule(localctx, 48, potigolParser.RULE_caso);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 426;
...
potigolParser.prototype.padrao = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 50;
    this.enterRecursionRule(localctx, 50, potigolParser.RULE_padrao, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 457;
        ...
        case 5:
            ...
            do {
                ...
                this._errHandler.sync(this);
                _la = this._input.LA(1);
            } while(_la===potigolParser.T__3 || _la===potigolParser.T__8 || ((((_la - 39)) & ~0x1f) == 0 && ((1 << (_la - 39)) & ((1 << (potigolParser.T__38 - 39)) | (1 << (potigolParser.ID - 39)) | (1 << (potigolParser.INT - 39)) | (1 << (potigolParser.FLOAT - 39)) | (1 << (potigolParser.STRING - 39)) | (1 << (potigolParser.BS - 39)) | (1 << (potigolParser.CHAR - 39)) | (1 << (potigolParser.BOOLEANO - 39)))) !== 0));
            this.state = 450;
            this.match(potigolParser.T__9);
            break;
        ...
        case 6:
            ...
            this.state = 454;
            _la = this._input.LA(1);
            if(_la===potigolParser.T__3 || _la===potigolParser.T__8 || ((((_la - 39)) & ~0x1f) == 0 && ((1 << (_la - 39)) & ((1 << (potigolParser.T__38 - 39)) | (1 << (potigolParser.ID - 39)) | (1 << (potigolParser.INT - 39)) | (1 << (potigolParser.FLOAT - 39)) | (1 << (potigolParser.STRING - 39)) | (1 << (potigolParser.BS - 39)) | (1 << (potigolParser.CHAR - 39)) | (1 << (potigolParser.BOOLEANO - 39)))) !== 0)) {
                this.state = 453;
                this.padrao(0);
            }
...
potigolParser.prototype.repeticao = function() {
    ...
    this.enterRule(localctx, 52, potigolParser.RULE_repeticao);
    try {
        this.state = 488;
        this._errHandler.sync(this);
...
potigolParser.prototype.para_faca = function() {
    ...
    this.enterRule(localctx, 54, potigolParser.RULE_para_faca);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 490;
...
potigolParser.prototype.para_gere = function() {
    ...
    this.enterRule(localctx, 56, potigolParser.RULE_para_gere);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 498;
...
potigolParser.prototype.enquanto = function() {
    ...
    this.enterRule(localctx, 58, potigolParser.RULE_enquanto);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 508;
...
potigolParser.prototype.faixa = function() {
    ...
    this.enterRule(localctx, 60, potigolParser.RULE_faixa);
    var _la = 0; // Token type
    try {
        this.state = 524;
        this._errHandler.sync(this);
        ...
        case 2:
            ...
            this.match(potigolParser.ID);
            this.state = 516;
            this.match(potigolParser.T__53);
            this.state = 517;
            this.expr(0);
            this.state = 518;
            _la = this._input.LA(1);
            if(!(_la===potigolParser.T__54 || _la===potigolParser.T__55)) {
            this._errHandler.recoverInline(this);
            }
            else {
                this.consume();
            ...
            this.state = 522;
            _la = this._input.LA(1);
            if(_la===potigolParser.T__56) {
                this.state = 520;
                this.match(potigolParser.T__56);
                this.state = 521;
                this.expr(0);
            }
...
potigolParser.prototype.faixas = function() {
    ...
    this.enterRule(localctx, 62, potigolParser.RULE_faixas);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 526;
...
potigolParser.prototype.bloco = function() {
    ...
    this.enterRule(localctx, 64, potigolParser.RULE_bloco);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 534;
        _la = this._input.LA(1);
        if(!(_la===potigolParser.T__57 || _la===potigolParser.T__58)) {
        this._errHandler.recoverInline(this);
        }
        else {
            this.consume();
...
potigolParser.prototype.expr1 = function() {
    ...
    this.enterRule(localctx, 66, potigolParser.RULE_expr1);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 538;
...
potigolParser.prototype.expr2 = function() {
    ...
    this.enterRule(localctx, 68, potigolParser.RULE_expr2);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 546;
        this.expr(0);
...
potigolParser.prototype.id1 = function() {
    ...
    this.enterRule(localctx, 70, potigolParser.RULE_id1);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 553;
...
potigolParser.prototype.id2 = function() {
    ...
    this.enterRule(localctx, 72, potigolParser.RULE_id2);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 561;
...
potigolParser.prototype.qualid = function() {
    ...
    this.enterRule(localctx, 74, potigolParser.RULE_qualid);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 572;
        this._errHandler.sync(this);
...
potigolParser.prototype.qualid1 = function() {
    ...
    this.enterRule(localctx, 76, potigolParser.RULE_qualid1);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 577;
...
potigolParser.prototype.qualid2 = function() {
    ...
    this.enterRule(localctx, 78, potigolParser.RULE_qualid2);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 585;
...
potigolParser.prototype.tipo2 = function() {
    ...
    this.enterRule(localctx, 80, potigolParser.RULE_tipo2);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 592;
...
potigolParser.prototype.exprlist = function() {
    ...
    this.enterRule(localctx, 82, potigolParser.RULE_exprlist);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 602;
